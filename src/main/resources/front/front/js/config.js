...
{
	name: '车辆展示',
	url: './pages/cheliangzhanshi/list.html'
}, 
...
var adminurl =  "http://localhost:8080/springbootil05r/admin/dist/index.html";
