<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="材料名称" prop="cailiaomingcheng">
          <el-input v-model="ruleForm.cailiaomingcheng" 
              placeholder="材料名称" clearable  :readonly="ro.cailiaomingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="材料名称" prop="cailiaomingcheng">
              <el-input v-model="ruleForm.cailiaomingcheng" 
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="材料分类" prop="cailiaofenlei">
          <el-select v-model="ruleForm.cailiaofenlei" placeholder="请选择材料分类">
            <el-option
                v-for="(item,index) in cailiaofenleiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="材料分类" prop="cailiaofenlei">
	      <el-input v-model="ruleForm.cailiaofenlei"
                placeholder="材料分类" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="材料介绍" prop="cailiaojieshao">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.cailiaojieshao" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.cailiaojieshao" label="材料介绍" prop="cailiaojieshao">
                    <span v-html="ruleForm.cailiaojieshao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='cailiaomingcheng'){
            this.ruleForm.cailiaomingcheng = obj[o];
	    this.ro.cailiaomingcheng = true;
            continue;
          }
          if(o=='cailiaofenlei'){
            this.ruleForm.cailiaofenlei = obj[o];
	    this.ro.cailiaofenlei = true;
            continue;
          }
          if(o=='guige'){
	    ...
	    this.ro.tupian = true;
          ...
          if(o=='cailiaojieshao'){
            this.ruleForm.cailiaojieshao = obj[o];
	    this.ro.cailiaojieshao = true;
            continue;
          }
        }
      }
	...
	this.ruleForm.cailiaojieshao = this.ruleForm.cailiaojieshao.replace(reg,'../../../springbootil05r/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `weixiucailiao/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.weixiucailiaoCrossAddOrUpdateFlag = false;
                  this.parent.search();
